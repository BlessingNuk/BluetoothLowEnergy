 ...
 * Advertising Data
 */
static char local_name[] = { AD_TYPE_COMPLETE_LOCAL_NAME, 'N', 'O', 'D', 'E', '_', '_', 'A'};
...
static void Ble_Hci_Gap_Gatt_Init(void); //we understand this
  ...
  switch (event_pckt->evt)
  {
        ...
        case ACI_GAP_PROC_COMPLETE_VSEVT_CODE:
        {
              ...
              && gap_evt_proc_complete->Status == 0x00)
          {
            /* USER CODE BEGIN GAP_GENERAL_DISCOVERY_PROC */
        	  printf("\n\r...SCANNING COMPLETE...\n\r");
        	 //printf(gap_evt_proc_complete->Data);
            ...
            {
              printf("\n\r...INITIATING CONNECTION TO SERVER WITH ADDRESS: "); //if addr == xx connected to dev x
          	for(int i=0;i<6;i++){
                printf("%x.",P2P_SERVER1_BDADDR[i]);//print out address of the connected device
             }
             printf("...\n\r");
    ...
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
      ...
      if (cc->Connection_Handle == BleApplicationContext.connectionHandleEndDevice1)
      {
        ...
        printf("\n\r...TERMINATING CONNECTION TO SERVER...\n\r");
        BleApplicationContext.EndDevice_Connection_Status[0] = APP_BLE_IDLE;
...
/* USER CODE BEGIN FD */
void terminate_connection(uint16_t conn_handle){

	tBleStatus ret = hci_disconnect(conn_handle, 0x13);
	//ret = aci_gap_terminate(conn_handle, 0x13);
	return;
}
/* USER CODE END FD */
/*************************************************************
...
static void Ble_Hci_Gap_Gatt_Init(void){
  ...
  const uint8_t *bd_addr; //device address
   ...
   */
   if (BleApplicationContext.BleApplicationContext_legacy.bleSecurityParam.bonding_mode)
   {
	...
	//  uint8_t addr1[] = {0xe4,0xbf,0x21,0xe1,0x80,0x00,};
	  //uint8_t addr2[] = {0x2F,0xc4,0x21,0xe1,0x80,0x00,};
//	 uint8_t addr3[] = {0x00,0x80,0xe1,0x21,0xbf,0x57};
  //   hci_le_add_device_to_white_list(PUBLIC_ADDR, (uint8_t*)addr1);
    // hci_le_add_device_to_white_list(PUBLIC_ADDR, (uint8_t*)addr2);
//     hci_le_add_device_to_white_list(PUBLIC_ADDR, (uint8_t*)addr3);
...
static void Adv_Request( void )
{
  ...
  if (BleApplicationContext.SmartPhone_Connection_Status != APP_BLE_CONNECTED)
  {
    ...
    result = aci_gap_set_discoverable(ADV_IND,
                                      ...
                                      0,
                                      0);
  /*  aci_gap_set_discoverable(Advertising_Type,
...
static void ConnReq1( void )
{
  ...
  if (BleApplicationContext.EndDevice_Connection_Status[0] != APP_BLE_CONNECTED)
  {
    /* USER CODE BEGIN APP_BLE_CONNECTED_SUCCESS_END_DEVICE_1 */
	 // uint8_t addr2[] = {0x00,0x80,0xe1,0x21,0xc4,0x2F};
...
/* USER CODE END Evt_Notification_1 */
  ...
  switch (pNotification->P2P_Evt_Opcode)
  {
    ...
    case SMART_PHONE1_CONN_HANDLE_EVT:
    	...
    	printf("\n\r...CONNECTED TO CLIENT...\n\r");
    	printf("\n\r...PREPARE TO RECEIVE DATA...\n\r");
    ...
    case P2P_SERVER1_CONN_HANDLE_EVT:
      ...
      P2PR_APP_End_Device_Mgt_Connection_Update(&device_status); //method is in router app
      break;

    case P2P_SERVER1_DISCON_HANDLE_EVT:
      HAL_GPIO_WritePin(LED_BLUE_GPIO_Port, LED_BLUE_Pin, GPIO_PIN_RESET);
      printf("\n\r...CONNECTION TO SERVER TERMINATED...\n\r");
      device_status.Device1_Status = 0x80; /* Not connected */
      P2PR_APP_End_Device_Mgt_Connection_Update(&device_status); //method is in router app
      /* restart Create Connection */
      HAL_Delay(4000);
      UTIL_SEQ_SetTask(1 << CFG_TASK_START_ADV_ID, CFG_SCH_PRIO_0);//maybe scan instead??//IMPLEMENT timeout change to idle
      break;

    case SMART_PHONE1_DISCON_HANDLE_EVT:
      HAL_GPIO_WritePin(LED_BLUE_GPIO_Port, LED_BLUE_Pin, GPIO_PIN_RESET);
      printf("\n\r...CONNECTION TO CLIENT TERMINATED...\n\r");
      HAL_Delay(100);
      UTIL_SEQ_SetTask(1 << CFG_TASK_START_SCAN_ID, CFG_SCH_PRIO_0);
      break;
